function add_or_remove_component(world, condition, component_c_ref, componentClass, entities) {
    ...
    for (let ent of entities) {
        if (condition)
            ent.setComponent(component_c_ref, new componentClass());  // adds a new component
        else {
